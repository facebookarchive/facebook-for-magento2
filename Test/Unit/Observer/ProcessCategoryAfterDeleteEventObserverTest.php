...
class ProcessCategoryAfterDeleteEventObserverTest extends CommonTest{
    ...
    public function setUp() {
        ...
        $this->processCategoryAfterDeleteEventObserver = new \Facebook\BusinessExtension\Observer\ProcessCategoryAfterDeleteEventObserver( $this->fbeHelper);
    }
    ...
    public function testExcution(){
        ...
        $res = $this->processCategoryAfterDeleteEventObserver->execute($this->_eventObserverMock);
        $this->assertNull($res);
    }
}
