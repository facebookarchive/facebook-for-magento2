...
class GoogleProductCategory extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    /**
     * Get all options
     *
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            $this->_options = [
                ...
                ['value' => 'Animals & Pet Supplies > Live Animals', 'label' => __('Animals & Pet Supplies > Live Animals')],
                ['value' => 'Animals & Pet Supplies > Pet Supplies', 'label' => __('Animals & Pet Supplies > Pet Supplies')],
                ...
                ['value' => 'Apparel & Accessories > Clothing Accessories', 'label' => __('Apparel & Accessories > Clothing Accessories')],
                ['value' => 'Apparel & Accessories > Costumes & Accessories', 'label' => __('Apparel & Accessories > Costumes & Accessories')],
                ['value' => 'Apparel & Accessories > Handbag & Wallet Accessories', 'label' => __('Apparel & Accessories > Handbag & Wallet Accessories')],
                ['value' => 'Apparel & Accessories > Handbags, Wallets & Cases', 'label' => __('Apparel & Accessories > Handbags, Wallets & Cases')],
                ['value' => 'Apparel & Accessories > Jewelry', 'label' => __('Apparel & Accessories > Jewelry')],
                ['value' => 'Apparel & Accessories > Shoe Accessories', 'label' => __('Apparel & Accessories > Shoe Accessories')],
                ['value' => 'Apparel & Accessories > Shoes', 'label' => __('Apparel & Accessories > Shoes')],
                ['value' => 'Arts & Entertainment', 'label' => __('Arts & Entertainment')],
                ['value' => 'Arts & Entertainment > Event Tickets', 'label' => __('Arts & Entertainment > Event Tickets')],
                ['value' => 'Arts & Entertainment > Hobbies & Creative Arts', 'label' => __('Arts & Entertainment > Hobbies & Creative Arts')],
                ['value' => 'Arts & Entertainment > Party & Celebration', 'label' => __('Arts & Entertainment > Party & Celebration')],
                ...
                ['value' => 'Baby & Toddler > Baby Toys & Activity Equipment', 'label' => __('Baby & Toddler > Baby Toys & Activity Equipment')],
                ['value' => 'Baby & Toddler > Baby Transport', 'label' => __('Baby & Toddler > Baby Transport')],
                ['value' => 'Baby & Toddler > Baby Transport Accessories', 'label' => __('Baby & Toddler > Baby Transport Accessories')],
                ...
                ['value' => 'Baby & Toddler > Swaddling & Receiving Blankets', 'label' => __('Baby & Toddler > Swaddling & Receiving Blankets')],
                ['value' => 'Business & Industrial', 'label' => __('Business & Industrial')],
                ['value' => 'Business & Industrial > Advertising & Marketing', 'label' => __('Business & Industrial > Advertising & Marketing')],
                ['value' => 'Business & Industrial > Agriculture', 'label' => __('Business & Industrial > Agriculture')],
                ['value' => 'Business & Industrial > Automation Control Components', 'label' => __('Business & Industrial > Automation Control Components')],
                ['value' => 'Business & Industrial > Construction', 'label' => __('Business & Industrial > Construction')],
                ['value' => 'Business & Industrial > Dentistry', 'label' => __('Business & Industrial > Dentistry')],
                ['value' => 'Business & Industrial > Film & Television', 'label' => __('Business & Industrial > Film & Television')],
                ['value' => 'Business & Industrial > Finance & Insurance', 'label' => __('Business & Industrial > Finance & Insurance')],
                ['value' => 'Business & Industrial > Food Service', 'label' => __('Business & Industrial > Food Service')],
                ['value' => 'Business & Industrial > Forestry & Logging', 'label' => __('Business & Industrial > Forestry & Logging')],
                ['value' => 'Business & Industrial > Hairdressing & Cosmetology', 'label' => __('Business & Industrial > Hairdressing & Cosmetology')],
                ['value' => 'Business & Industrial > Heavy Machinery', 'label' => __('Business & Industrial > Heavy Machinery')],
                ['value' => 'Business & Industrial > Hotel & Hospitality', 'label' => __('Business & Industrial > Hotel & Hospitality')],
                ['value' => 'Business & Industrial > Industrial Storage', 'label' => __('Business & Industrial > Industrial Storage')],
                ['value' => 'Business & Industrial > Industrial Storage Accessories', 'label' => __('Business & Industrial > Industrial Storage Accessories')],
                ['value' => 'Business & Industrial > Janitorial Carts & Caddies', 'label' => __('Business & Industrial > Janitorial Carts & Caddies')],
                ['value' => 'Business & Industrial > Law Enforcement', 'label' => __('Business & Industrial > Law Enforcement')],
                ['value' => 'Business & Industrial > Manufacturing', 'label' => __('Business & Industrial > Manufacturing')],
                ['value' => 'Business & Industrial > Material Handling', 'label' => __('Business & Industrial > Material Handling')],
                ['value' => 'Business & Industrial > Medical', 'label' => __('Business & Industrial > Medical')],
                ['value' => 'Business & Industrial > Mining & Quarrying', 'label' => __('Business & Industrial > Mining & Quarrying')],
                ['value' => 'Business & Industrial > Piercing & Tattooing', 'label' => __('Business & Industrial > Piercing & Tattooing')],
                ['value' => 'Business & Industrial > Retail', 'label' => __('Business & Industrial > Retail')],
                ['value' => 'Business & Industrial > Science & Laboratory', 'label' => __('Business & Industrial > Science & Laboratory')],
                ['value' => 'Business & Industrial > Signage', 'label' => __('Business & Industrial > Signage')],
                ['value' => 'Business & Industrial > Work Safety Protective Gear', 'label' => __('Business & Industrial > Work Safety Protective Gear')],
                ['value' => 'Cameras & Optics', 'label' => __('Cameras & Optics')],
                ['value' => 'Cameras & Optics > Camera & Optic Accessories', 'label' => __('Cameras & Optics > Camera & Optic Accessories')],
                ...
                ['value' => 'Electronics > Circuit Boards & Components', 'label' => __('Electronics > Circuit Boards & Components')],
                ...
                ['value' => 'Electronics > Electronics Accessories', 'label' => __('Electronics > Electronics Accessories')],
                ['value' => 'Electronics > GPS Accessories', 'label' => __('Electronics > GPS Accessories')],
                ['value' => 'Electronics > GPS Navigation Systems', 'label' => __('Electronics > GPS Navigation Systems')],
                ...
                ['value' => 'Electronics > Print, Copy, Scan & Fax', 'label' => __('Electronics > Print, Copy, Scan & Fax')],
                ...
                ['value' => 'Electronics > Toll Collection Devices', 'label' => __('Electronics > Toll Collection Devices')],
                ['value' => 'Electronics > Video', 'label' => __('Electronics > Video')],
                ['value' => 'Electronics > Video Game Console Accessories', 'label' => __('Electronics > Video Game Console Accessories')],
                ...
                ['value' => 'Food, Beverages & Tobacco > Beverages', 'label' => __('Food, Beverages & Tobacco > Beverages')],
                ['value' => 'Food, Beverages & Tobacco > Food Items', 'label' => __('Food, Beverages & Tobacco > Food Items')],
                ['value' => 'Food, Beverages & Tobacco > Tobacco Products', 'label' => __('Food, Beverages & Tobacco > Tobacco Products')],
                ['value' => 'Furniture', 'label' => __('Furniture')],
                ['value' => 'Furniture > Baby & Toddler Furniture', 'label' => __('Furniture > Baby & Toddler Furniture')],
                ...
                ['value' => 'Furniture > Entertainment Centers & TV Stands', 'label' => __('Furniture > Entertainment Centers & TV Stands')],
                ...
                ['value' => 'Furniture > Office Furniture Accessories', 'label' => __('Furniture > Office Furniture Accessories')],
                ...
                ['value' => 'Furniture > Outdoor Furniture Accessories', 'label' => __('Furniture > Outdoor Furniture Accessories')],
                ['value' => 'Furniture > Room Divider Accessories', 'label' => __('Furniture > Room Divider Accessories')],
                ...
                ['value' => 'Hardware > Heating, Ventilation & Air Conditioning', 'label' => __('Hardware > Heating, Ventilation & Air Conditioning')],
                ['value' => 'Hardware > Locks & Keys', 'label' => __('Hardware > Locks & Keys')],
                ['value' => 'Hardware > Plumbing', 'label' => __('Hardware > Plumbing')],
                ['value' => 'Hardware > Power & Electrical Supplies', 'label' => __('Hardware > Power & Electrical Supplies')],
                ...
                ['value' => 'Health & Beauty > Jewelry Cleaning & Care', 'label' => __('Health & Beauty > Jewelry Cleaning & Care')],
                ['value' => 'Health & Beauty > Personal Care', 'label' => __('Health & Beauty > Personal Care')],
                ['value' => 'Home & Garden', 'label' => __('Home & Garden')],
                ['value' => 'Home & Garden > Bathroom Accessories', 'label' => __('Home & Garden > Bathroom Accessories')],
                ['value' => 'Home & Garden > Business & Home Security', 'label' => __('Home & Garden > Business & Home Security')],
                ['value' => 'Home & Garden > Decor', 'label' => __('Home & Garden > Decor')],
                ['value' => 'Home & Garden > Emergency Preparedness', 'label' => __('Home & Garden > Emergency Preparedness')],
                ['value' => 'Home & Garden > Fireplace & Wood Stove Accessories', 'label' => __('Home & Garden > Fireplace & Wood Stove Accessories')],
                ['value' => 'Home & Garden > Fireplaces', 'label' => __('Home & Garden > Fireplaces')],
                ['value' => 'Home & Garden > Flood, Fire & Gas Safety', 'label' => __('Home & Garden > Flood, Fire & Gas Safety')],
                ['value' => 'Home & Garden > Household Appliance Accessories', 'label' => __('Home & Garden > Household Appliance Accessories')],
                ['value' => 'Home & Garden > Household Appliances', 'label' => __('Home & Garden > Household Appliances')],
                ...
                ['value' => 'Home & Garden > Lighting Accessories', 'label' => __('Home & Garden > Lighting Accessories')],
                ['value' => 'Home & Garden > Linens & Bedding', 'label' => __('Home & Garden > Linens & Bedding')],
                ['value' => 'Home & Garden > Parasols & Rain Umbrellas', 'label' => __('Home & Garden > Parasols & Rain Umbrellas')],
                ['value' => 'Home & Garden > Plants', 'label' => __('Home & Garden > Plants')],
                ['value' => 'Home & Garden > Pool & Spa', 'label' => __('Home & Garden > Pool & Spa')],
                ['value' => 'Home & Garden > Smoking Accessories', 'label' => __('Home & Garden > Smoking Accessories')],
                ['value' => 'Home & Garden > Umbrella Sleeves & Cases', 'label' => __('Home & Garden > Umbrella Sleeves & Cases')],
                ...
                ['value' => 'Luggage & Bags > Cosmetic & Toiletry Bags', 'label' => __('Luggage & Bags > Cosmetic & Toiletry Bags')],
                ...
                ['value' => 'Luggage & Bags > Luggage Accessories', 'label' => __('Luggage & Bags > Luggage Accessories')],
                ...
                ['value' => 'Media > Carpentry & Woodworking Project Plans', 'label' => __('Media > Carpentry & Woodworking Project Plans')],
                ...
                ['value' => 'Office Supplies > Desk Pads & Blotters', 'label' => __('Office Supplies > Desk Pads & Blotters')],
                ['value' => 'Office Supplies > Filing & Organization', 'label' => __('Office Supplies > Filing & Organization')],
                ['value' => 'Office Supplies > General Office Supplies', 'label' => __('Office Supplies > General Office Supplies')],
                ...
                ['value' => 'Office Supplies > Office & Chair Mats', 'label' => __('Office Supplies > Office & Chair Mats')],
                ...
                ['value' => 'Office Supplies > Office Instruments', 'label' => __('Office Supplies > Office Instruments')],
                ['value' => 'Office Supplies > Paper Handling', 'label' => __('Office Supplies > Paper Handling')],
                ['value' => 'Office Supplies > Presentation Supplies', 'label' => __('Office Supplies > Presentation Supplies')],
                ['value' => 'Office Supplies > Shipping Supplies', 'label' => __('Office Supplies > Shipping Supplies')],
                ['value' => 'Religious & Ceremonial', 'label' => __('Religious & Ceremonial')],
                ['value' => 'Religious & Ceremonial > Memorial Ceremony Supplies', 'label' => __('Religious & Ceremonial > Memorial Ceremony Supplies')],
                ['value' => 'Religious & Ceremonial > Religious Items', 'label' => __('Religious & Ceremonial > Religious Items')],
                ['value' => 'Religious & Ceremonial > Wedding Ceremony Supplies', 'label' => __('Religious & Ceremonial > Wedding Ceremony Supplies')],
                ['value' => 'Software', 'label' => __('Software')],
                ['value' => 'Software > Computer Software', 'label' => __('Software > Computer Software')],
                ['value' => 'Software > Digital Goods & Currency', 'label' => __('Software > Digital Goods & Currency')],
                ...
                ['value' => 'Sporting Goods > Exercise & Fitness', 'label' => __('Sporting Goods > Exercise & Fitness')],
                ['value' => 'Sporting Goods > Indoor Games', 'label' => __('Sporting Goods > Indoor Games')],
                ['value' => 'Sporting Goods > Outdoor Recreation', 'label' => __('Sporting Goods > Outdoor Recreation')],
                ...
                ['value' => 'Toys & Games > Outdoor Play Equipment', 'label' => __('Toys & Games > Outdoor Play Equipment')],
                ...
                ['value' => 'Vehicles & Parts > Vehicle Parts & Accessories', 'label' => __('Vehicles & Parts > Vehicle Parts & Accessories')],
